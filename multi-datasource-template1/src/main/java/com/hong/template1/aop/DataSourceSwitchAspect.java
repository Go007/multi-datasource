package com.hong.template1.aop;

import com.hong.template1.common.DBTypeEnum;
import com.hong.template1.common.DataSourceSwitch;
import com.hong.template1.common.DbContextHolder;
...
public class DataSourceSwitchAspect {
    ...
    @Pointcut("execution(public * com.hong.template1.service.db1..*.*(..))")
    private void db1Aspect() {
    }

    @Pointcut("execution(public * com.hong.template1.service.db2..*.*(..))")
